...
const Home = () => {
  return (
    <div name="home" className='h-screen w-full bg-gradient-to-b from-black via-black to-gray-800 px-4'>
        <div className='max-w-screen-lg mx-auto flex flex-col md:flex-row px-4 items-center justify-center h-full'>
